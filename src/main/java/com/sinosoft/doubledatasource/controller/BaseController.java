...
//import com.sinosoft.ops.archive.common.BaseResult;
//import com.sinosoft.ops.archive.common.BaseResultHttpStatus;
//import com.sinosoft.ops.archive.common.constant.Constants;
//import com.sinosoft.ops.archive.common.exception.BusinessException;
//import com.sinosoft.ops.archive.common.exception.SystemException;
...
//
//    public static final Logger logger = LoggerFactory.getLogger(com.sinosoft.ops.archive.controller.BaseController.class);
//
//    /**
//     * 映射路径--创建
//     */
//    public static final String MAPPING_PATH_ADD= "/add";
//    /**
//     * 映射路径--修改
//     */
//    public static final String MAPPING_PATH_MODIFY = "/modify";
//    /**
//     * 映射路径--删除
//     */
...
//     * 映射路径--列表查询
//     */
//    public static final String MAPPING_PATH_LIST = "/list";
//
...
//        return new ResponseEntity(BaseResult.fail(message), HttpStatus.OK);
//    }
//
...
//     * @return 参数值
//     */
//    public String getUUIDParam(HttpServletRequest request, String paramName, UUID nullValue) {
//        String value = request.getParameter(paramName);
//        if (value != null && !"".equals(value)) {
//            try {
//                return value;
...
//     * @return 参数值
//     */
//    public String getUUIDParam(HttpServletRequest request, String paramName) {
